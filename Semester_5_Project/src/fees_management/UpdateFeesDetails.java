...
public class UpdateFeesDetails extends javax.swing.JFrame {
    ...
    public void setrecords()
    {
        ...
        try {
            ...
            ResultSet rs = pst.executeQuery();
            rs.next();
            txt_recepitno.setText(rs.getString("reciept_no"));
            combopaymentmode.setSelectedItem(rs.getString("payment_mode"));
            txtcheckno.setText(rs.getString("cheque_no"));
            txtddno.setText(rs.getString("dd_no"));
            txt_bankname.setText(rs.getString("bank_name"));
            txt_recivedfromuser.setText(rs.getString("student_name"));
            ...
            chombocourse.setSelectedItem(rs.getString("courses"));
